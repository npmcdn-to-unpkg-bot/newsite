...
@section('content')
	...
	<div class="container-fluid">
		<div class="container">
			<div class="col-xs-12 col-sm-6">
				<h1 class="m-t-100">Vinyl Decals STARTING AT</h1>
				<div class="price-container">
					<div class="h1 price-old">$7 sq.ft</div>
					<div class="h1 price">$<span>4</span> sq.ft<div class="new-price-banner">New price!</div></div>
				</div>
				<p style="font-size:22px">Our window decals give new meaning to the term "window shopping!" Now you can turn your empty window into a marketing opportunity with our window clings and decals.</p>
			</div>
			<div class="col-xs-12 col-sm-6">
				<img class="img-responsive" src="{{asset('assets/images/laptop.png')}}" alt="LAPTOP" style="margin-top:40px" />
			</div>
		</div>
	</div>
	...
	<div class="container-fluid section-examples">
		<div class="container">
			<h2>Vinyl Window Signs are Printed in<br />
			Full Color and Can be Square Cut or Shape Cut.</h2>
			<div class="row">
				<div class="col-xs-12 col-sm-4">
					<img class="img-responsive" src="{{asset('assets/images/examples/example_1.png')}}" alt="example" />
				</div>
				<div class="col-xs-12 col-sm-4">
					<img class="img-responsive" src="{{asset('assets/images/examples/example_2.png')}}" alt="example" />
				</div>
				<div class="col-xs-12 col-sm-4">
					<img class="img-responsive" src="{{asset('assets/images/examples/example_3.png')}}" alt="example" />
				</div>
			</div>
			
			<h2>Perforated Window Signs are used at store display windows<br />
			due to their ability to send clear message  to passers by and yet<br />
			to those being indoors leaving 100% visibility. It is made from<br />
			mechanically perforated film which makes Perforated<br />
			Window Sign easily removable.</h2>
			<div class="row">
				<div class="col-xs-12 col-sm-4">
					<img class="img-responsive" src="{{asset('assets/images/examples/example_4.png')}}" alt="example" />
				</div>
				<div class="col-xs-12 col-sm-4">
					<img class="img-responsive" src="{{asset('assets/images/examples/example_5.png')}}" alt="example" />
				</div>
				<div class="col-xs-12 col-sm-4">
					<img class="img-responsive" src="{{asset('assets/images/examples/example_6.png')}}" alt="example" />
				</div>
			</div>
		</div>
	</div>
