...
@section('content')
	...
	<div class="container-fluid">
		<div class="container">
			<div class="col-xs-12 col-sm-7">
				<h1 class="m-t-100">Posters STARTING AT</h1>
				<div class="price-container">
					<div class="h1 price-old">$5 sq.ft</div>
					<div class="h1 price">$<span>3</span> sq.ft<div class="new-price-banner">New price!</div></div>
				</div>
				<p style="font-size:22px">Get your message out fast—just unroll,<br /> 
				hang and be seen.</p>
			</div>
			<div class="col-xs-12 col-sm-5">
				<img class="img-responsive" src="{{asset('assets/images/ninja.png')}}" alt="LAPTOP" style="margin-top:40px" />
			</div>
		</div>
	</div>
	...
	<div class="container-fluid section-examples">
		<div class="container">
			<h2>Announce your news with personalized posters.<br />
			Getting ready for a sale, special promotion or event?<br />
			Place an eye-catching poster in your store window, on community<br /> 
			bulletin boards or at local hotspots.</h2>
			<div class="row">
				<div class="col-xs-12 col-sm-4">
					<img class="img-responsive" src="{{asset('assets/images/examples/example_7.png')}}" alt="example" />
				</div>
				<div class="col-xs-12 col-sm-4">
					<img class="img-responsive" src="{{asset('assets/images/examples/example_8.png')}}" alt="example" />
				</div>
				<div class="col-xs-12 col-sm-4">
					<img class="img-responsive" src="{{asset('assets/images/examples/example_9.png')}}" alt="example" />
				</div>
			</div>
		</div>
	</div>
